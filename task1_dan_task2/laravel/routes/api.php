...
Route::middleware('auth:api')->prefix('/youtube')->group(function () {
    Route::get('populars/list', [YoutubeController::class, 'getPopularsList']);
    Route::get('populars/chart', [YoutubeController::class, 'getPopularsChart']);
});
